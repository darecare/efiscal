...
// N
	...
	*/
	...
	/** Set eFiscal_type.
		@param eFiscal_type eFiscal_type
	*/
	public void seteFiscal_type (String eFiscal_type)
	{
		set_Value (COLUMNNAME_eFiscal_type, eFiscal_type);
	}

	/** Get eFiscal_type.
		@return eFiscal_type	  */
	public String geteFiscal_type()
	{
		return (String)get_Value(COLUMNNAME_eFiscal_type);
	}
}